...
<div class="main">
    <form class="form-horizontal" action="/addInfo" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="phone" name="userName" placeholder="phoneNumber">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button id="finish" type="button" class="btn btn-default" onclick="location.href='/'">完成
                </button>
            </div>
        </div>
    </form>
