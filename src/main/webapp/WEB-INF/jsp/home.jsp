        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="example-navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">我的拼购</a></li>
                    <li><a href="#">我的订单</a></li>
                    <li><a href="#">购物车</a></li>
                    <li>
                        <a href="#">我的收藏</a>
...
<div id="left">
    <div class="btn-group-vertical" id="navigation-vertical">
        <button class="btn btn-primary">手机</button>
        <button class="btn btn-success">电脑</button>
        <button class="btn btn-info">服装</button>
        <button class="btn btn-warning">食品</button>
        <button class="btn btn-danger">图书</button>
    </div>
</div>
